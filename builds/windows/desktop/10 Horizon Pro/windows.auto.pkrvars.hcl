...
scripts = ["scripts/windows/windows-prepare.ps1", "scripts/windows/powercli.ps1", "scripts/windows/copy-datastoreinstallers.ps1",  "scripts/windows/horizon/agent.ps1", "scripts/windows/horizon/appvolumes.ps1", "scripts/windows/horizon/dem.ps1", "scripts/windows/horizon/fslogix.ps1", "scripts/windows/o365.ps1", "scripts/windows/teams.ps1"]
inline = [
